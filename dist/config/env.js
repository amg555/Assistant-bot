...
export const isWhatsAppConfigured = Boolean(env.WHATSAPP_APP_SECRET &&
...
export const isNotionConfigured = Boolean(env.NOTION_OAUTH_CLIENT_ID && env.NOTION_OAUTH_CLIENT_SECRET && env.NOTION_TOKEN_ENCRYPTION_KEY);
