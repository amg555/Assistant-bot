 ...
 */
webhookIncomingRouter.post("/webhooks/incoming/:accountId", async (req, res) => {
    try {
        ...
        logError("webhookIncoming", err, { accountId: req.params.accountId });
        res.status(500).json({ error: "internal_error" });
    }
});
//# sourceMappingURL=webhookIncomingRoute.js.map