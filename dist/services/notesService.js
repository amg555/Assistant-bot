...
export async function createNote(accountId, input) {
    try {
...
export async function deleteNote(accountId, noteId) {
    try {
...
export async function getNoteById(accountId, noteId) {
    try {
        const { data, error } = await supabaseAdmin
            .from("notes")
...
export async function getNoteByNotionPageId(pageId) {
    try {
        const { data, error } = await supabaseAdmin
            .from("notes")
            .select("id, account_id, title, body, notion_page_id, notion_last_synced_edit, updated_at")
...
export async function linkNoteToNotionPage(noteId, notionPageId, lastEditedTime) {
    try {
...
export async function applyInboundNotionEdit(noteId, title, body, lastEditedTime) {
    try {
        const { error } = await supabaseAdmin
            .from("notes")
...
export async function setNoteEmbedding(accountId, noteId, embeddingLiteral) {
    try {
        const { error } = await supabaseAdmin
            .from("notes")
...
export async function listRecentNotes(accountId, limit = 10) {
    try {
        const { data, error } = await supabaseAdmin
            .from("notes")
