...
export function parseRelativeDurationMs(input: string): number | null {
...
export function parseHourOfDay(input: string): number | null {
...
const RECURRENCE_WORDS: Record<string, RecurrenceRule> = {
  daily: "daily",
  "every day": "daily",
  everyday: "daily",
  weekly: "weekly",
...
export function extractRecurrence(input: string): { recurrence: RecurrenceRule; remaining: string } {
...
export function computeNextOccurrence(rule: RecurrenceRule, previousUtc: Date): Date | null {
